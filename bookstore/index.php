            ...
            <div class="row">
                <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2">
                    <div class="intro">
                        ...
                        <p class="text-center"></p><img class="img-fluid" src="assets/img/books/<?php echo $row["Id"]; ?>.jpg"></div>
                    <div class="text">

                        <h3 class="text-center">Author: <?php echo $row["writer"]; ?></h3>
                        <h4 class="text-center">Price: <?php echo $row["Price"]; ?>$</h4>
						
						<?php if(isset($_SESSION['id'])){?>
						<?php $uid = $_SESSION['id'];
						$sql2 = "select * from cart where u_id=".$uid." and p_id=".$pid; 
						$result2 = mysqli_query($conn, $sql2); ?>
						<?php if (mysqli_num_rows($result2) > 0)	{ ?>
						<h4 class="text-center">Bood is Added to the cart</h4>
						<?php } else {?>
						<form class = "addToCart" action="addtocart.php" method="post" >
						<input type="hidden" name="id" value=<?php echo $row["Id"];?>>
						<button class="btn btn-success float-none justify-content-center" type="submit" style="width:300px;margin:0px;margin-left:230px;margin-right:230px;">Add To Shopping Cart</button>
						</form>
						<?php }} else {?>
