        ...
        <div class="form-container">
            <form method="post"  action="assets/php/register.php">
               ...
               -->
			    ...
			    <div class="form-group"><input required   class="form-control" type="text" name="squestion" placeholder="Write Your Question Here; Users must answer this question to follow you in MoodIn"></div>
                
				<div class="form-group"><input required  class="form-control" type="password" name="sanswer" placeholder="Write Your Secret Answer Here; Users must write this answer to follow"></div>
