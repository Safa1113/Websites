...
<?php
	if(isset($_SESSION['id'])){
		   ...
		   $user4 = $db->timelinea($_SESSION['id']);
...
<?php } else {?>
    ...
    <div class="projects-horizontal">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Audio Mood</h2>
                <p class="text-center">To Change The Mood Press Mood Logo Above</p>
            </div>
        </div>
    </div>
    <div class="container">
...
<br/>
 ...
 -->
		...
		<div class="intro">
		 ...
		 <h5 class="text-center">Nothing is Here Yet!!</h5>
		 </br></br>
		</div>
		<!-- end of else action -->
		...
		<div class="intro">
		 ...
		 <h5 class="text-center">Please Login to View Users' Posts</h5>
		 </br></br>
		</div>
		<!-- end of else action -->
