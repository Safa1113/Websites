...
<?php } else {?>
    ...
    <div class="register-photo">
        <div class="form-container">
			...
			<?php 
			 if( isset($_GET['IAM']) && isset($_GET['follows'])){
			$user = $db->getUserSQByName($_GET['follows']);
			?>
			...
			<input type="hidden" name="follows" value="<?php echo $_GET['follows'] ?>">
                ...
                <h2 class="text-center"><strong>Answer This Question: <?php if($user) echo $user; ?>?</strong></h2>
