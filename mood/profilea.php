...
<?php } else {?>
    ...
    <div class="projects-horizontal">
		...
		$user5 = $db->getUserIDByName($_GET['username']);
		 $user2 = $db->isUserfollowinga($_SESSION['id'], $user5 );
		...
		?>
            ...
            <div class="intro">
				...
				<a class="btn btn-light btn-block ml-auto action-button" role="button" href="follow.php?IAM=<?php echo $_SESSION['id']   ?>&follows=<?php echo $_GET['username']   ?>" style="margin:4px;margin-left:0px;background-color:rgb(153,176,174);">Follow</a>
...
<br/>
	...
	<small style="margin-left:30px;font-size:15px;">Date : <?php echo $user4[$count]["date_"];   ?></small>
				<a href="replya.php?PID=<?php echo $user4[$count]["ID"];?>"><small style="margin-left:30px;font-size:15px;">Replies : <?php echo $user4[$count]["replies"];   ?></small></a>
